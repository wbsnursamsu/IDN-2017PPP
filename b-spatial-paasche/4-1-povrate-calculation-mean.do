...
* exppl data
    ...
    rename kabcode rege
    merge m:1 year prov rege using "${gdOutput}/spdef-mean-reg-2010-2022.dta"
        drop if _merge==2
        drop _merge
    ...
    preserve
		keep if year==2013
		drop pdef
		merge m:1 year prov urban using "${gdOutput}/spdef-mean-str-2010-2022.dta"
		drop if _merge==2 
		drop _merge
		tempfile dat2013
...
save "${gdOutput}/1-povrate-index-2010-2022-mean.dta", replace    
...
* tables
    ...
    #delimit cr
    collect preview
    putexcel set "${gdOutput}/1-povrate-sum-2010-2022-mean.xlsx", sheet("all_index", replace) modify
    putexcel B2 = collect
    ...
    #delimit cr
    collect preview
    putexcel set "${gdOutput}/1-povrate-sum-2010-2022-mean.xlsx", sheet("all_index_urb", replace) modify
    putexcel B2 = collect
    ...
    #delimit cr    
    collect preview
    putexcel set "${gdOutput}/1-povrate-sum-2010-2022-mean.xlsx", sheet("all_index_rur", replace) modify
    putexcel B2 = collect
...
* save data and graph
    ...
    * national
    ...
    #delimit;
        ...
        export excel using "${gdOutput}/1-povrate-sum-2010-2022-mean.xlsx", firstrow(variables) sheet("national", replace);        
    ...
    * urban rural
    ...
    #delimit;
        ...
        export excel using "${gdOutput}/1-povrate-sum-2010-2022-mean.xlsx", firstrow(variables) sheet("urbanrural", replace);
    ...
    #delimit;
        ...
        export excel using "${gdOutput}/1-povrate-sum-2010-2022-mean.xlsx", firstrow(variables) sheet("region", replace);        
    #delimit cr
    restore
    ...
    #delimit;
        ...
        export excel using "${gdOutput}/1-povrate-sum-2010-2022-mean.xlsx", firstrow(variables) sheet("province", replace);
    #delimit cr 
    restore
    ...
    #delimit;
        ...
        export excel using "${gdOutput}/1-povrate-sum-2010-2022-mean.xlsx", firstrow(variables) sheet("stratum", replace);
    #delimit cr
    restore
    ...
    #delimit;
        ...
        export excel using "${gdOutput}/1-povrate-sum-2010-2022-mean.xlsx", firstrow(variables) sheet("regency", replace);
    #delimit cr    
    restore
