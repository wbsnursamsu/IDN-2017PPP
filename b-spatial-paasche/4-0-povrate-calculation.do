...
* exppl data
    ...
    rename kabcode rege
    merge m:1 year prov rege using "${gdOutput}/spdef-med-reg-2010-2022.dta"
        drop if _merge==2
        drop _merge
    ...
    preserve
		keep if year==2013
		drop pdef
		merge m:1 year prov urban using "${gdOutput}/spdef-med-str-2010-2022.dta"
		drop if _merge==2 
		drop _merge
		tempfile dat2013
...
save "${gdOutput}/1-povrate-index-2010-2022.dta", replace    
...
* tables
    ...
    #delimit cr
    collect preview
    putexcel set "${gdOutput}/1-povrate-sum-2010-2022.xlsx", sheet("all_index", replace) modify
    putexcel B2 = collect
    ...
    #delimit cr
    collect preview
    putexcel set "${gdOutput}/1-povrate-sum-2010-2022.xlsx", sheet("all_index_urb", replace) modify
    putexcel B2 = collect
    ...
    #delimit cr    
    collect preview
    putexcel set "${gdOutput}/1-povrate-sum-2010-2022.xlsx", sheet("all_index_rur", replace) modify
    putexcel B2 = collect
