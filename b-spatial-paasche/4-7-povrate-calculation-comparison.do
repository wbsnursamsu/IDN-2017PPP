...
save `pdef13', replace
    ...
    // merge with testing spatial deflator
    merge m:1 prov rege year using "${gdOutput}/02-spdef-rgc-ff-2023-comp.dta", nogen 
    merge m:1 prov rege year using "${gdOutput}/02-spdef-rgc-all-2022-comp.dta", nogen
...
* spatially adjusted pov rate and adjust using base year urban deflator    
    ...
    gen poor_ipl215_d = (rdpcexp_ppp2017_d/pdef/udef2017)<2.15
    gen poor_ipl365_d = (rdpcexp_ppp2017_d/pdef/udef2017)<3.65
    gen poor_ipl685_d = (rdpcexp_ppp2017_d/pdef/udef2017)<6.85

    gen poor_ipl19_d = (rdpcexp_ppp2011_d/pdef/udef2011)<1.9
    gen poor_ipl32_d = (rdpcexp_ppp2011_d/pdef/udef2011)<3.2
    gen poor_ipl55_d = (rdpcexp_ppp2011_d/pdef/udef2011)<5.5    

* poverty rate test

    gen poor_ipl215_t1 = (rdpcexp_ppp2017_d/pdef_ff/udef2017)<2.15
    gen poor_ipl365_t1 = (rdpcexp_ppp2017_d/pdef_ff/udef2017)<3.65
    gen poor_ipl685_t1 = (rdpcexp_ppp2017_d/pdef_ff/udef2017)<6.85

    gen poor_ipl215_t2 = (rdpcexp_ppp2017_d/pdef_all/udef2017)<2.15
    gen poor_ipl365_t2 = (rdpcexp_ppp2017_d/pdef_all/udef2017)<3.65
    gen poor_ipl685_t2 = (rdpcexp_ppp2017_d/pdef_all/udef2017)<6.85
...
save "${gdOutput}/10-povrate-2022-2023-test.dta", replace    
...
//     #delimit cr
//     collect preview
//     collect export "${gdOutput}/1-povrate-sum-2000-2023.xlsx", sheet("all_index", replace) modify
//
//     #delimit;
...
//     #delimit cr
//     collect preview
//     collect export "${gdOutput}/1-povrate-sum-2000-2023.xlsx", sheet("all_index_urb", replace) modify
//
//     #delimit;
...
//     #delimit cr    
//     collect preview
//     collect export "${gdOutput}/1-povrate-sum-2000-2023.xlsx", sheet("all_index_rur", replace) modify
//   
// * save data and graph
//     // national level
//     * national
...
//         poor_ipl19 poor_ipl19_d poor_ipl32 poor_ipl32_d poor_ipl55 poor_ipl55_d
//         [w=weind], by(year);
//         export excel using "${gdOutput}/1-povrate-sum-2000-2023.xlsx", firstrow(variables) sheet("national", replace);        
//		
//     #delimit cr
//     restore
//   
...
//         export excel using "${gdOutput}/1-povrate-sum-2000-2023.xlsx", firstrow(variables) sheet("urbanrural", replace);
//       
//     #delimit cr 
//     restore
//  
...
//         export excel using "${gdOutput}/1-povrate-sum-2000-2023.xlsx", firstrow(variables) sheet("region", replace);        
//     #delimit cr
//     restore
//
...
//         export excel using "${gdOutput}/1-povrate-sum-2000-2023.xlsx", firstrow(variables) sheet("reg_all", replace);        
//     #delimit cr
//     restore
//    
//     // province level
...
//         export excel using "${gdOutput}/1-povrate-sum-2000-2023.xlsx", firstrow(variables) sheet("province", replace);
//     #delimit cr 
//     restore
//       
...
//         export excel using "${gdOutput}/1-povrate-sum-2000-2023.xlsx", firstrow(variables) sheet("stratum", replace);
//     #delimit cr
//     restore
//       
//     // regency level
...
//         export excel using "${gdOutput}/1-povrate-sum-2000-2023.xlsx", firstrow(variables) sheet("regency", replace);
//     #delimit cr    
//     restore
