	#delimit;
	use "${gdOutput}/1-povrate-index-2010-2022.dta", clear;
	...
	use "${gdOutput}/1-povrate-index-2010-2022.dta", clear	;
		...
		twoway 	
			...
			xtitle("Year") ytitle("P0 Rate")
		    xlabel(2010(1)2022, labsize(vsmall)) ylabel(,labsize(vsmall)) leg(size(vsmall));
		graph export "$gdOutput/Graphs2/1-povrate-comparison-region-rur.png", replace;
		...
		twoway 	
			...
			xtitle("Year") ytitle("P0 Rate")
		    xlabel(2010(1)2022, labsize(vsmall)) ylabel(,labsize(vsmall)) leg(size(vsmall));
		graph export "$gdOutput/Graphs2/1-povrate-comparison-region-urb.png", replace;
