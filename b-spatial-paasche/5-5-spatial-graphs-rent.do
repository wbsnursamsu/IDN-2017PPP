	#delimit;
	use "${gdOutput}/1-povrate-index-2010-2022-rn.dta", clear;
	...
	twoway 
        ...
        graph export "${gdOutput}/Graphs-rn/1-povrate-comparison-nat.png", replace;
	#delimit cr
	...
	twoway 
        ...
        legend(label(1 "NPL") 
               ...
               label(7 "IPL 6.85 USD 2017 PPP - Deflated")) 
               xlabel(2010(1)2022, labsize(vsmall)) ylabel(,labsize(vsmall)) leg(size(vsmall));
        graph export "${gdOutput}/Graphs-rn/1-povrate-comparison-nat-urb.png", replace;
	...
	twoway 
        ...
        legend(label(1 "NPL") 
               ...
               label(7 "IPL 6.85 USD 2017 PPP - Deflated")) 
               xlabel(2010(1)2022, labsize(vsmall)) ylabel(,labsize(vsmall)) leg(size(vsmall));
        graph export "${gdOutput}/Graphs-rn/1-povrate-comparison-nat-rur.png", replace;
	...
	use "${gdOutput}/1-povrate-index-2010-2022-rn.dta", clear	;
		...
		twoway 	
			...
			xtitle("Year") ytitle("P0 Rate")
		    xlabel(2010(1)2022, labsize(vsmall)) ylabel(,labsize(vsmall)) leg(size(vsmall));
		graph export "$gdOutput/Graphs-rn/1-povrate-comparison-region-rur.png", replace;
		...
		twoway 	
			...
			xtitle("Year") ytitle("P0 Rate")
		    xlabel(2010(1)2022, labsize(vsmall)) ylabel(,labsize(vsmall)) leg(size(vsmall));
		graph export "$gdOutput/Graphs-rn/1-povrate-comparison-region-urb.png", replace;
