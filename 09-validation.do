...
*** Data prep
* Merge
merge m:1 year using "$gdOutput/Spatial Laspeyres Calibrator - 2.15 USD 2017 PPP - Food Deflation.dta", nogen
rename (alphaR alphaU) (alphaR19F alphaU19F)
merge m:1 year using "$gdOutput/Spatial Laspeyres Calibrator - 3.65 USD 2017 PPP - Food Deflation.dta", nogen
rename (alphaR alphaU) (alphaR32F alphaU32F)
merge m:1 year using "$gdOutput/Spatial Laspeyres Calibrator - 6.85 USD 2017 PPP - Food Deflation.dta", nogen
...
replace rpcexp_ppp_fooddefl_19 = (y_pcexp_fooddefl_19/cpi2017/icp17/365)
gen poor_IPL215_fooddefl = rpcexp_ppp_fooddefl_19 < 2.15
...
replace rpcexp_ppp_fooddefl_32 = (y_pcexp_fooddefl_32/cpi2017/icp17/365)
gen poor_IPL365_fooddefl = rpcexp_ppp_fooddefl_32 < 3.65
...
replace rpcexp_ppp_fooddefl_55 = (y_pcexp_fooddefl_55/cpi2017/icp17/365)
gen poor_IPL685_fooddefl = rpcexp_ppp_fooddefl_55 < 6.85
...
label variable alphaR19F "Calibrated rural food deflator - 2.15 USD 2017 PPP"
label variable alphaU19F "Calibrated urban food deflator - 2.15 USD 2017 PPP"
label variable alphaR32F "Calibrated rural food deflator - 3.65 USD 2017 PPP"
label variable alphaU32F "Calibrated urban food deflator - 3.65 USD 2017 PPP"
label variable alphaR55F "Calibrated rural food deflator - 6.85 USD 2017 PPP"
label variable alphaU55F "Calibrated urban food deflator - 6.85 USD 2017 PPP"
...
label variable rpcexp_ppp_fooddefl_19 "Real daily percapita consumption (st food + t nonfood) adjusted to Povcalnet 2.15 USD 2017 PPP FGT0"
label variable rpcexp_ppp_fooddefl_32 "Real daily percapita consumption (st food + t nonfood) adjusted to Povcalnet 3.65 USD 2017 PPP FGT0"
label variable rpcexp_ppp_fooddefl_55 "Real daily percapita consumption (st food + t nonfood) adjusted to Povcalnet 6.85 USD 2017 PPP FGT0"
...
tw (line poor_NPL year if urban == 0, lp(solid) lcol(maroon)) (line poor_NPL year if urban == 1, lp(solid) lcol(navy)) (line poor_IPL215 year if urban == 0, lp(dash) lcol(maroon)) (line poor_IPL215 year if urban == 1, lp(dash) lcol(navy)), title("Standard IPL 2.15 USD 2017 PPP and NPL Poverty Rate") legend(label(1 "National Poverty Rate - Rural") label(2 "National Poverty Rate  - Urban") label(3 "IPL 2.15 USD 2017 PPP - Rural")  label(4 "IPL 2.15 USD 2017 PPP - Urban")) graphregion(color(white)) scale(0.75)
...
tw (line poor_NPL year if urban == 0, lp(solid) lcol(maroon)) (line poor_NPL year if urban == 1, lp(solid) lcol(navy)) (line poor_IPL215 year if urban == 0, lp(dash) lcol(maroon)) (line poor_IPL215 year if urban == 1, lp(dash) lcol(navy)), by(region, title("Standard IPL 2.15 USD 2017 PPP and NPL Poverty Rate") graphregion(color(white)) scale(0.75)) legend(label(1 "National Poverty Rate - Rural") label(2 "National Poverty Rate  - Urban") label(3 "IPL 2.15 USD 2017 PPP - Rural") label(4 "IPL 2.15 USD 2017 PPP - Urban")) 
...
forval i = 0/2  {
	...
	use "$gdOutput/Spatial Laspeyres Calibrator - `ipl' USD PPP - Food Deflation.dta", clear
