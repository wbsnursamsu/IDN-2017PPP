...
*	Subtask			: -
*	Input			: SUSENAS 2012 Consumption Module (September)
*	Note			: -
********************************************************************************
...
**** Data prep 2012
	...
	*** Consumption Module 41 (food), 229 unique code
	use "$gdData/SUSENAS/Data/MODULE/susenas12sep_41.dta",clear
	...
	* Converts data to 1 month period q and v
	use "$gdData/SUSENAS/Data/MODULE/susenas12sep_42.dta", clear
	egen urut = concat(b1r1-b1r8)
...
**** Append
	...
	use `sep12_41'
	append using `sep12_42'
	merge m:1 urut b1r1-b1r8 using `sep12_43', nogen
...
**** Save
	...
	save "$gdTemp/SUS_Mod12-SEPTEMBER.dta", replace
