...
*	Task			: SUSENAS Extracting Data for Consumption Module 2022
*	Subtask			: -
*	Input			: SUSENAS 2022 Consumption Module
*	Note			: -
********************************************************************************
...
**** Data prep 2021
	...
	*** Consumption Module 41 (food), 188 unique code
	use "$gdData/SUSENAS/Data/MODULE/susenas22mar_41.dta",clear
	*isid urut kode
	codebook kode
	...
	*** Consumption Module 42 (non-food)
	use "$gdData/SUSENAS/Data/MODULE/susenas22mar_42.dta",clear
	*isid urut kode
	...
	* Consumption Module 43 (total)
	use "$gdData/SUSENAS/Data/MODULE/susenas22mar_43.dta", clear
	*isid urut
...
**** Append
	...
	merge m:1 urut r101-r105 using `mar22_43', nogen
...
**** Save
	...
	save "$gdTemp/SUS_Mod22.dta", replace
	
	* if needed
	use "$gdTemp/SUS_Mod22.dta", clear
	isid urut kode