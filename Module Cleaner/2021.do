********************************************************************************
*	SUSENAS 2021 Consumption Module

clear all
cap log close
log using "${gdLog}/03-sus-cm-mar-2021.log", replace
...
use "${gdSUS}/MODULE/susenas21mar_41.dta",clear
...
use "${gdSUS}/MODULE/susenas21mar_42.dta",clear
tostring urut, replace
destring(r101-r105), replace
...
merge m:1 provcode kabcode using "${gdTemp}/region-crosswalk-2021.dta", keepusing(bps_code_all name_all)
drop if _merge==2
drop _merge
...
compress
save "$gdTemp/sus-cm-mar-2021.dta", replace
su shv_*