...
*	Task			: SUSENAS Extracting Data for Consumption Module 2021
*	Subtask			: -
*	Input			: SUSENAS 2021 Consumption Module
*	Note			: -
********************************************************************************
...
**** Data prep 2021
	...
	*** Consumption Module 41 (food), 188 unique code
	use "$gdData/SUSENAS/Data/MODULE/susenas21mar_41.dta",clear
	*isid urut kode
	codebook kode
	...
	*** Consumption Module 42 (non-food)
	use "$gdData/SUSENAS/Data/MODULE/susenas21mar_42.dta",clear
	*isid urut kode
	...
	* Consumption Module 43 (total)
	use "$gdData/SUSENAS/Data/MODULE/susenas21mar_43.dta", clear
	*isid urut
...
**** Append
	...
	use `mar21_41'
	append using `mar21_42'
	merge m:1 urut r101-r105 using `mar21_43', nogen
...
**** Save
	...
	save "$gdTemp/SUS_Mod21.dta", replace
	
	* if needed
	use "$gdTemp/SUS_Mod21.dta", clear
	*isid urut kode