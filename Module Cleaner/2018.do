...
*	Task			: SUSENAS Extracting Data for Consumption Module 2018
*	Subtask			: -
*	Input			: SUSENAS 2018 Consumption Module
*	Note			: -
********************************************************************************
...
**** Data prep 2018
	...
	*** Consumption Module 41 (food), 188 unique code
	use "$gdData/SUSENAS/Data/MODULE/susenas18mar_41.dta",clear
	*isid urut kode
	codebook kode
	...
	*** Consumption Module 42 (non-food)
	use "$gdData/SUSENAS/Data/MODULE/susenas18mar_42.dta",clear
	*isid urut kode
	...
	* Consumption Module 43 (total)
	use "$gdData/SUSENAS/Data/MODULE/susenas18mar_43.dta", clear
	*isid urut
...
**** Append
	...
	use `mar18_41'
	append using `mar18_42'
	merge m:1 urut r101-r105 using `mar18_43', nogen
	...
	* Merge with food crosswalk data
	...
	merge m:m code18 using "$gdData/Crosswalk/consumption_module_crosswalk.dta", keepusing(code11 code15 code17 code18 composite)
	drop if _merge == 2
	drop _merge
...
**** Save
	...
	save "$gdTemp/SUS_Mod18.dta", replace
	
	* if needed
	use "$gdTemp/SUS_Mod18.dta", clear
	isid urut kode