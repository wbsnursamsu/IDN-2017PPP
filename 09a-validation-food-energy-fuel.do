...
forval i = 0/2  {
	...
	graph export "$gdOutput/Graphs-food-fuel-energy/PA_Standard vs Adjusted IPL `ipl2' P0 - National - PPP2017.png", replace
}
...
forval i = 0/2  {
	...
	collapse (mean) poor_IPL`ipl'* [w=weind], by(year urban)
	tw (line poor_IPL`ipl' year, lp(solid) lcol(maroon)) (line poor_IPL`ipl'_fooddefl year, lp(dash_dot) lcol(maroon)), by(urban, scale(0.75) graphregion(color(white)) title("Standard vs Adjusted IPL `ipl2' - National")) legend(label(1 "`ipl2' IPL") label(2 "`ipl2' IPL - Spatially Deflated"))  xtitle("Year") ytitle("P0 Rate")
	graph export "$gdOutput/Graphs-food-fuel-energy/PA_Standard vs Adjusted IPL `ipl2' P0 - National - PPP2011.png", replace
}
...
forval i = 0/2  {
	...
	graph export "$gdOutput/Graphs-food-fuel-energy/PA_Standard vs Adjusted IPL `ipl2' P0 - by Region All Graphs-food-fuel-energy.png", replace
}
